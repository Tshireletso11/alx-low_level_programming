 ...
 * @fd: The file descriptor that are to be closed.
 */
void close_file(int fd)
{
	int c;
 ...
 * Return: 0 on success.
 *
 * Description: If the argument count is incorrect then sow- exit code 97.
 * If file_from does not exist or cannot be read then show- exit code 98.
 * If file_to cannot be created or written to then show- exit code 99.
 * If file_to or file_from cannot be closed then show- exit code 100.
 */
