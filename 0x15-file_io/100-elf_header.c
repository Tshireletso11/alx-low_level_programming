 ...
 *
 * Description: If the file is not an ELF file then show - exit code 98.
 */
void check_elf(unsigned char *e_ident)
{
	int index;
 ...
 *
 * Description: If the file cannot be closed then show - exit code 98.
 */
void close_elf(int elf)
{
	if (close(elf) == -1)
 ...
 * the function fails then show - exit code 98.
 */
